...
const Modal = ({title, children, onClose, overLayClick}) => {
  ...
  return (
    ...
    <div className='fixed inset-0 w-full overflow-y-auto'>
        <div className='flex z-50 min-h-full w-full items-center justify-center p-4 text-center' onClick={overLayClick}>
